...
{   
    ...
    {  
        ...
        {
            List<KeyValuePair<string, object>> ParaMeterCollection = new List<KeyValuePair<string, object>>();
            ParaMeterCollection.Add(new KeyValuePair<string, object>("@DashBoardStartDate", DateTimeHelper.GetUtcTime(StartDate)));
            ParaMeterCollection.Add(new KeyValuePair<string, object>("@DashBoardEndDate", DateTimeHelper.GetUtcTime(EndDate)));  
        ...
        internal  List<DashboardStatisticInfo> GetMonthlySiteStatistics(string yearFrom,string yearTo)
        {
            try
            {
                List<KeyValuePair<string, object>> ParaMeterCollection = new List<KeyValuePair<string, object>>();
                ParaMeterCollection.Add(new KeyValuePair<string, object>("@YearFrom", yearFrom));
                ParaMeterCollection.Add(new KeyValuePair<string, object>("@YearTo", yearTo));

                SQLHandler SQLH = new SQLHandler();
                return SQLH.ExecuteAsList<DashboardStatisticInfo>("[dbo].[usp_GetMonthlyVisitStatistics]", ParaMeterCollection);
            }
            catch (Exception ex)
            {
        ...
        internal List<SiteCompleteInfo> GetSiteComplete(int userModuleID,int portalID,string cultureCode)
        {
            try
            {
                List<KeyValuePair<string, object>> ParaMeterCollection = new List<KeyValuePair<string, object>>();
                ParaMeterCollection.Add(new KeyValuePair<string, object>("@UserModuleID", userModuleID));
                ParaMeterCollection.Add(new KeyValuePair<string, object>("@PortalID", portalID));
                ParaMeterCollection.Add(new KeyValuePair<string, object>("@Culture", cultureCode));
                SQLHandler SQLH = new SQLHandler();
                return SQLH.ExecuteAsList<SiteCompleteInfo>("[dbo].[usp_EasyBuilder_GetSiteCompleteness]",ParaMeterCollection);
            }
            catch (Exception ex)
            {
                throw ex;
