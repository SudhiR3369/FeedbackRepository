...
namespace DashBoardControl
{
    ...
    public class DashBoardController
    {
        ...
        public List<DashboardStatisticInfo> GetMonthlySiteStatistics(string yearFrom, string yearTo)
        {
            DashBoardDataProvider objProv = new DashBoardDataProvider();
            return objProv.GetMonthlySiteStatistics(yearFrom, yearTo);
        }
        public List<SiteCompleteInfo> GetSiteCompleteness(int userModuleID, int portalID, string cultureCode)
        {
            DashBoardDataProvider objProv = new DashBoardDataProvider();
            return objProv.GetSiteComplete(userModuleID,portalID,cultureCode);
        }
    }
