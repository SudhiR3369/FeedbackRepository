...
namespace SageFrame.Dashboard
{
    ...
    public class DashboardDataProvider
    {
        ...
        #region "Dashboard QuickView"
        public int AddUpdateGroup(GroupInfo obj)
        {
            try
            {
                List<KeyValuePair<string, object>> param = new List<KeyValuePair<string, object>>();
                param.Add(new KeyValuePair<string, object>("@GroupID", obj.GroupID));
                param.Add(new KeyValuePair<string, object>("@GroupName", obj.GroupName));
                param.Add(new KeyValuePair<string, object>("@Order", obj.GroupOrder));
                param.Add(new KeyValuePair<string, object>("@Status", obj.Status));
                ...
                param.Add(new KeyValuePair<string, object>("@UpdatedBy", obj.UpdatedBy));
                param.Add(new KeyValuePair<string, object>("@GroupType", obj.GroupType));
                ...
                SQLHandler sagesql = new SQLHandler();
                return sagesql.ExecuteNonQuery("[dbo].[usp_Group_Insert]", param, "@newGroupID");
            }
            catch
            {
                throw;
        ...
        public void DeleteGroupByID(int GroupID)
        {
            ...
            {
                List<KeyValuePair<string, object>> param = new List<KeyValuePair<string, object>>();
                param.Add(new KeyValuePair<string, object>("@GroupID", GroupID));
                SQLHandler sagesql = new SQLHandler();
                sagesql.ExecuteNonQuery("[dbo].[usp_Group_DeleteByID]", param);
            }
            catch
            {
                throw;
        ...
        public int AddUpdateGroupItem(GroupItemInfo obj)
        {
            try
            {
                List<KeyValuePair<string, object>> param = new List<KeyValuePair<string, object>>();
                param.Add(new KeyValuePair<string, object>("@ItemID", obj.ItemID));
                param.Add(new KeyValuePair<string, object>("@IsIngroup", obj.IsInGroup));
                param.Add(new KeyValuePair<string, object>("@GroupID", obj.GroupID));
                param.Add(new KeyValuePair<string, object>("@ItemOrder", obj.ItemOrder));
                param.Add(new KeyValuePair<string, object>("@PageID", obj.PageID));
                param.Add(new KeyValuePair<string, object>("@AddedBy", obj.AddedBy));
                param.Add(new KeyValuePair<string, object>("@UpdatedBy", obj.UpdatedBy));
                param.Add(new KeyValuePair<string, object>("@PortalID", obj.PortalID));
                param.Add(new KeyValuePair<string, object>("@UserModuleID", obj.UserModuleID));
                param.Add(new KeyValuePair<string, object>("@Culture", obj.Culture));
                SQLHandler sagesql = new SQLHandler();
                return sagesql.ExecuteNonQuery("[dbo].[usp_GroupItem_AddUpdate]", param, "@newItemID");
            }
            catch
            {
                throw;
        ...
        public List<GroupItemInfo> GroupGetAll(int portalID, string pageName, string userName)
        {
            try
            {
                List<KeyValuePair<string, object>> param = new List<KeyValuePair<string, object>>();
                param.Add(new KeyValuePair<string, object>("@PageSEOName", pageName));
                param.Add(new KeyValuePair<string, object>("@PortalID", portalID));
                param.Add(new KeyValuePair<string, object>("@UserName", userName));
                SQLHandler sagesql = new SQLHandler();
                return sagesql.ExecuteAsList<GroupItemInfo>("[dbo].[usp_Group_GetAll]", param);
            }
            catch
            {
                throw;
        ...
        public void UpdateGroupOrder(string groupOrder)
        {
            try
            {
                List<KeyValuePair<string, object>> param = new List<KeyValuePair<string, object>>();
                param.Add(new KeyValuePair<string, object>("@GroupOrder", groupOrder));
                SQLHandler sagesql = new SQLHandler();
                sagesql.ExecuteNonQuery("[dbo].[usp_Group_UpdateGroupOrder]", param);
            }
            catch
            {
                throw;
