...
namespace SageFrame.Dashboard
{
    ...
    public class DashboardController
    {
        ...
        public int AddUpdateGroup(GroupInfo obj)
        {
            try
            {
                DashboardDataProvider objDataProvider = new DashboardDataProvider();
                return objDataProvider.AddUpdateGroup(obj);
            }
            catch
            {
                throw;
        ...
        public void DeleteGroupByID(int GroupID)
        {
            ...
            {
                DashboardDataProvider objDataProvider = new DashboardDataProvider();
                objDataProvider.DeleteGroupByID(GroupID);
            }
            catch
            {
                throw;
        ...
        {
            DashboardDataProvider objDataProvider = new DashboardDataProvider();
            return objDataProvider.AddUpdateGroupItem(obj);
        }
        public List<GroupItemInfo> GroupGetAll(int portalID, string pageName, string userName)
        {
            DashboardDataProvider objDataProvider = new DashboardDataProvider();
            return objDataProvider.GroupGetAll(portalID, pageName, userName);
        }
        public void UpdateGroupOrder(string groupOrder)
        {
            DashboardDataProvider objDataProvider = new DashboardDataProvider();
            objDataProvider.UpdateGroupOrder(groupOrder);
        }
        #endregion
    }
}
