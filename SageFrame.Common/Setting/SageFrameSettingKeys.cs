...
namespace SageFrame.Web
{
    ...
    public static class SageFrameSettingKeys
    {
        ...
        public static string ColorCombos = "ColorCombos";
        ...
        /* New Keyes for user setting*/
        public static string AllowDuplicateEmail = "AllowDuplicateEmail";
        public static string EnableCaptchaForUserRegistration = "EnableCaptchaForUserRegistration";
        ...
        public static string DigiSphereApi = "DigiSphereApi";
        public static string configurecode = "configurecode";
