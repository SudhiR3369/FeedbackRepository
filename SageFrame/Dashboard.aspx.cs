...
namespace SageFrame
{
    public partial class ClientDashboard : PageBase, SageFrameRoute
    {
        ...
        public string templateFavicon = "favicon.ico";
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            ...
            ltrLogo.ImageUrl = LoadLogoImage("dashboard");
        }
        ...
        private void SetPageInitPart()
        {
            ...
            CheckUserLogin();
            string PageName = GetDashBoardPageName();// Path.GetFileNameWithoutExtension(PagePath);
            if (PageName != null)
            {
        ...
        private void BindModuleControls()
        {
            ...
            SageUserControl suc = new SageUserControl();
            PagePath = GetDashBoardPageName();
            string PageName = GetDashBoardPageName();
        ...
        private string GetDashBoardPageName()
        {
            ...
            for (int i = 0; i < len; i++)
            {
                if (strArr[i].ToLower() == "dashboard" || strArr[i].ToLower() == "dashboard" + SageFrameSettingKeys.PageExtension)
                {
                    if (i < len - 1)
                    {
                        PageName = strArr[i + 1];
                    ...
                    {
                        PageName = "dashboard" + SageFrameSettingKeys.PageExtension;
                    }
                }
            }
            return PageName;
