...
<span class="pageHelp off sfBtnSml smlbtn-def">Page Help</span>
<div class="sfPageHelpHolder sfCpanel clearfix" style="display: none;">
    <h4>
        <%=pageName%>
    </h4>
    ...
    <div class="sfPageHelpMoreInfo" Style="display:none">
