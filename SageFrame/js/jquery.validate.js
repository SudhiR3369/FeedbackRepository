...
$.extend($.validator, {
    ...
    messages: {
        ...
        decimal: "Please enter valid decimal number.",
        ...
        phone: $.validator.format("Please enter a value phone no{0}."),
    ...
    prototype: {
        ...
        resetForm: function () {
            ...
            $(this.currentForm).find('.' + this.settings.errorClass).removeClass(this.settings.errorClass);
        },
    ...
    methods: {
        ...
        phone: function (value, element) {
            return this.optional(element) || /^\+?(\d[\d-. ]+)?(\([\d-. ]+\))?[\d-. ]+\d$/.test(value) && value.length <= 15 && value.length > 4;
        ...
        decimal: function (value, element) {
            return this.optional(element) || /^[0-9]{1,5}(\.[0-9]{0,4})?$/.test(value);
        },
        ipAddress: function (value, element) {
            return this.optional(element) || /^(((([1]?\d)?\d|2[0-4]\d|25[0-5])\.){3}(([1]?\d)?\d|2[0-4]\d|25[0-5]))|([\da-fA-F]{1,4}(\:[\da-fA-F]{1,4}){7})|(([\da-fA-F]{1,4}:){0,5}::([\da-fA-F]{1,4}:){0,5}[\da-fA-F]{1,4})$/.test(value);
        }
    }
