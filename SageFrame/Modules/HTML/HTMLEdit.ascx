        ...
        <ContentTemplate>
            ...
            <div id="divEditWrapper" runat="server" class="cssClassEditWrapper">
                <div class="sfFormwrapper">
                    <table cellspacing="0" cellpadding="0" border="0" width="95%" class="no-table-edit">
                        <tr>
                            <td>
                                <div class="cssClassHtmlViewBorder">
                                    <table cellspacing="0" cellpadding="0" border="0" id="tblTextEditor" width="100%" runat="server" class="cssClassHtmlViewTable no-table-edit">
                    ...
                    <div class="sfButtonwrapper">
                        <label class="sfLocale icon-save smlbtn-succ sfBtn">
                            Save
                            <asp:Button CssClass="imbSave" ID="imbSave" runat="server"  OnClick="imbSave_Click"
            ...
            <div id="divViewComment" style="display: none" runat="server" class="cssClassCommentWrapper">
                <div class="cssClassGridWrapper">
                    <div class="cssClassHtmlViewComentTable">
                        <asp:GridView ID="gdvHTMLList" runat="server" AutoGenerateColumns="False" Width="100%" GridLines="none" RowStyle-VerticalAlign="Top"
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <div class="cssClassCommentBy">
                                            <asp:Label ID="lblAddedBy" runat="server" Text='<%#Eval("AddedBy") + " on " + Eval("AddedOn") + " Says:"%>' />
                                        </div>
