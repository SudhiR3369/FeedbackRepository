    ...
    var NewsLetter = {
        ...
        SaveEmailSubscriber: function () {
            ...
            if (NewsLetter.CheckPreviousEmailSubscription(email)) {
                ...
                $("#lblmessage").html(html).removeClass("success").addClass("invalid").show();
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $("#lblmessage").html(GetSystemLocale("Subscribed Successfully")).removeClass("invalid").addClass("success").show();
                    },
                    error: function () {
                    }
                });
    ...
    $("#btnSubscribe").off().on("click", function (event) {
        ...
        if ($('input:radio[value=ByEmail]').prop('checked') == true) {
            ...
            if (!email_check.test(email)) {
                $('#divSubscribe>#lblmessage').text(GetSystemLocale("Invalid Email")).removeClass("success").addClass("invalid").show();
                return false;
            }
            else {
