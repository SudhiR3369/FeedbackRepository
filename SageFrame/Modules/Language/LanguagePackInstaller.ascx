...
<div class=" sfTableOption">
    <div class="sfRowfilter sfSorting noBorder">
        <div class="sfformKey">
        <asp:Wizard ID="wzrdInstallLanguagePack" runat="server" class="hideTD" Style="width: 100%"
            ...
            <StartNavigationTemplate>
                <div class="sfButtonwrapper">
                    <label class="sfLocale smlbtn-next icon-next smlbtn-succ sfBtn">
                        Next
            ...
            <WizardSteps>
                <asp:WizardStep runat="server" meta:resourcekey="WizardStepResource1">
                    <div class="divWizard">
                        ...
                        <label for='<%=fluLanguagePack.ClientID%>'></label>
                    </div>
                </asp:WizardStep>
                ...
                <div class="sfButtonwrapper">
                 <label class="sfLocale sfBtn">Previous <i class="icon-arrow-slimdouble-w"></i>
                    <asp:Button ID="StepPreviousButton" runat="server" CausesValidation="False" Text=""
                        ...
                        <label class="sfLocale smlbtn-succ sfBtn">Next <i class="icon-arrow-slimdouble-e"></i>
