...
<div id="langEditSecondDiv" runat="server" class="sfLanguage">
            ...
            <div class="sfFormwrapper sfPadding">
                ...
                <div class="sflanguagecontent" id="languageContent" runat="server">
                    ...
                    <div class="sfButtonWrapper sfTableOption clearfix">
                     <label class="sfLocale icon-delete smlbtn-danger sfBtn sfFloatRight">
                        Delete File
                    ...
                    <label class="sfLocale icon-save smlbtn-succ sfBtn sfFloatRight">
                        Save
                ...
                <label class="sfLocale icon-back smlbtn-danger sfBtn">
                        Back
    ...
    <div id="editorDiv" style="display: none">
        ...
        <div class="sfButtonwrapper sftype1">
            <label id="btnCloseFB" class="icon-save smlbtn-succ sfBtn">
                Save</label>
        </div>
    </div>
</div>
