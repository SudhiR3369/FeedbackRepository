...
<div>
                ...
                <ContentTemplate>
                    ...
                    <div>
                        <div id="tblPortalAddEdit" runat="server">
                                ...
                                <div id="Email" runat="server" class="sfFormwrapper">
                                    <div class="sfFieldset" runat="server" id="trEmail">
                                    ...
                                    <div class="sfFieldset" id="Tr1" runat="server">
                                        <div class="formKey" id="Td4"  runat="server">
                                        ...
                                        <div class="formValue" id="Td5" runat="server">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvPortalName" runat="server" Display="Dynamic" ErrorMessage="This field is required."
                                                ControlToValidate="txtPortalName" ValidationGroup="PortalManagement" CssClass="sfError"></asp:RequiredFieldValidator>
    ...
    <asp:Panel ID="pnlPortalList" runat="server" meta:resourcekey="pnlPortalListResource1">
        <div class="sfButtonwrapper ">
            <label class="icon-addnew smlbtn-primary sfBtn">
                Add Portal
