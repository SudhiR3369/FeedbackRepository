...
namespace SageFrame.Modules.Admin.SQL
{
    public partial class ctl_SqlQueryAnalyser : BaseAdministrationUserControl
    {
        ...
        {
            IncludeCss("sql", "/Administrator/Templates/Default/css/sqlanalyzer.css");
        }
        ...
        protected void btnDatabasebackup_Click(object sender, EventArgs e)
        {
            ...
            string dbBackupPath = Path.Combine(dbbackupFolder, DBName + ".bak");
            ...
            {
                string strURL = HostingEnvironment.ApplicationVirtualPath + "//Config//DBBackup//" + DBName + ".bak";
