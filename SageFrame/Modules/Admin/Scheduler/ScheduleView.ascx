...
<div id="wrapper">
    ...
    <div class="cssClassGridWrapper" id="divShowItemRatingDetails">
        <div class="sfButtonwrapper">
            ...
            <label class="icon-addnew smlbtn-primary sfBtn" onclick="ShowNewTaskPopUp(true)">
                Add New Task</label>
        </div>
    </div>
    <div class="sfGridwrapper">
        <div class="cssClassGridWrapperContent">
            ...
            <table id="gdvSchedularListAll"  width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse";>
            </table>
        </div>
    </div>
</div>
...
<div id="newScheduleDiv" class="invisibleDiv sfFormwrapper">
    <div class="cssClassPopUpBoxInfo cssClassPadding10 cssClassCurve">
        ...
        <h1>
            <span class="headerSpan">ADD NEW TASK</span></h1>
        ...
        <div class="sfFormwrapper">
            ...
            <div class="sfFieldset">
                <div class="formKey">
                    <span class="inline ">
                       <input type="checkbox" id="chkIsEnabled" checked="checked" /></span>
                    <span class="sfFormlabel">Enabled</span>
                </div>
                <div class="formValue">
            ...
            <div class="sfFieldset">
                <div class="formKey">
                    <asp:Panel ID="pnlRunningMode" runat="server" GroupingText="Running Mode">
                        <table cellpadding="0" cellspacing="0" width="100%" class="no-table">
                            <tr>
                                <td width="22%">
                                    <label>
                                        Start Date</label>
                                ...
                                <td>
                                    <input id="txtStartDate" type="text" class="cssClassNormalTextBox required" style="width: 90px;" />
                                    <label>
                                        End Date</label>
            ...
            <div class="sfFieldset">
                <div class="formKey">
                    <span class="sfFormlabel">
                        Retry Frequency</span>
                </div>
                <div class="formValue">
                    <input type="text" id="txtRetryFreq" class="cssClassNormalTextBox" style="width: 190px;"
                        maxlength="2" />
                    <select id="ddlRetryUnits" style="width: 40px;">
            ...
            <div class="sfFieldset" id="trDllUpload" style="display: ">
                <div class="formKey">
                    <span class="sfFormlabel">
                        Upload Assembly</span>
                </div>
                <div class="formValue">
                <label class="sfBtn smlbtn-succ icon-upload">
                Upload
            ...
            <div class="sfFieldset">
                <div class="formKey">
                    <span class="inline">
                        ...
                        <input type="checkbox" id="chkIsCatchUpEnabled" /></span>
                    <span class="sfFormlabel">Catch Up Enabled:</span>
                </div>
        ...
        <div class="sfButtonwrapper ">
            <span class="btnAddTaskspan">
                <button type="submit" id="btnAddTask" value="Add Task" class="sfBtn icon-addnew smlbtn-primary">Add Task</button>
