...
<asp:Panel ID="pnlAdsenseEdit" runat="server" meta:resourcekey="pnlAdsenseEditResource1">
    <div class="sfFormwrapper">
        <table width="100%" cellpadding="0" cellspacing="0" class="no-table">
            <tr>
                <td colspan="3">
        ...
        <div class="sfButtonwrapper button-paddleft">
            <asp:LinkButton ID="ImbPreview" ToolTip="Preview" runat="server" Text="Preview" OnClick="Preview_Click" CssClass="sfLocale icon-view smlbtn-primary sfBtn"
            ...
            <asp:LinkButton ID="ImbSave" runat="server" Text="Save" ToolTip="Save" OnClick="btnSave_Click" CssClass="sfLocale icon-save smlbtn-succ sfBtn"
           ...
           <%-- <asp:Label ID="lblSave" runat="server" Text="Save" AssociatedControlID="ImbSave"
            ...
            <asp:LinkButton ID="imbDelete" Visible="False" Text="Delete" ToolTip="Delete" runat="server" OnClick="imbDelete_Click" CssClass="sfLocale icon-close smlbtn-danger sfBtn"
