...
namespace SageFrame.Modules.Admin.Extensions
{
    ...
    public partial class ctl_Extensions : BaseAdministrationUserControl
    {
        ...
        protected void ImgNotInstallModule_Click(object sender, ImageClickEventArgs e)
        {
            string ControlPath = "/Modules/Admin/Extensions/Editors/NotInstallModule.ascx";
            ProcessSourceControlUrl(Request.RawUrl, ControlPath, "extension");
        }
        ...
        protected void ImgNotInstallModule_Click1(object sender, ImageClickEventArgs e)
        {
