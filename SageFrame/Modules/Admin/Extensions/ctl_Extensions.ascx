...
<div runat="server" id="notinstallmoduleWrapper" class="notinstallmoduleWrapper" visible="false">
    <asp:HiddenField ID="hdnFileName" runat="server" />
    <p>There are modules needed to be install for this active template.</p>
    <asp:ImageButton ID="ImgNotInstallModule" runat="server" OnClick="ImgNotInstallModule_Click" />
    <asp:Label Style="cursor: pointer;" ID="lblImgNotInstallModule" runat="server" CssClass="icon-download smlbtn-def sfBtn"
        Text="Click to install modules" AssociatedControlID="ImgNotInstallModule" />
</div>
...
<asp:PlaceHolder ID="ExtensionPlaceHolder" runat="server">
    <div class="sfButtonwrapper sfPadding sfHideImg">
        ...
        <asp:Label Style="cursor: pointer;" ID="lblInstallModule" runat="server" Text="Install Module"
            CssClass="icon-install smlbtn-succ sfBtn" AssociatedControlID="imbInstallModule" meta:resourcekey="lblInstallModuleResource1" />
        ...
        <asp:Label ID="lblCreateNewModule" runat="server" Text="Create New Module" AssociatedControlID="imbCreateNewModule"
            CssClass="icon-addnew smlbtn-def sfBtn" meta:resourcekey="lblCreateNewModuleResource1" />
        ...
        <asp:Label Style="cursor: pointer;" ID="lblCreatePackage" runat="server" Text="Create Package"
            CssClass="icon-addnew smlbtn-def sfBtn" AssociatedControlID="imbCreatePackage" meta:resourcekey="lblCreatePackageResource1" />
        ...
        <asp:Label Style="cursor: pointer;" ID="lblCreateCompositeModule" runat="server"
            CssClass="icon-addnew smlbtn-def sfBtn" Text="Create Composite Package" AssociatedControlID="imbCreateCompositeModule"
        ...
        <asp:Label Style="cursor: pointer;" ID="lblDownloadModules" runat="server" CssClass="icon-download smlbtn-def sfBtn"
            ...
            <div class="sfFieldset">
                <span class="formValue">
                    ...
                    <asp:Label ID="lblSearch" runat="server" Text="Search" AssociatedControlID="imgSearch"
                        CssClass="icon-search smlbtn-primary sfBtn" meta:resourcekey="lblSearchResource1"></asp:Label>
                </span>
            </div>
        </div>
    ...
    <div class="sfGridwrapper" id="divModulesLists">
        ...
        <asp:Label ID="lblSaveChanges" runat="server" Text="Save changes" AssociatedControlID="imbBtnSaveChanges"
            CssClass="icon-save smlbtn-succ sfBtn" Style="cursor: pointer;" meta:resourcekey="lblSaveChangesResource1"></asp:Label>
    </div>
</asp:PlaceHolder>