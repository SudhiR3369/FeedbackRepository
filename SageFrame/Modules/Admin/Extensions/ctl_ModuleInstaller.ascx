    ...
    <asp:Wizard ID="wizInstall" Width="100%" runat="server" DisplaySideBar="False" ActiveStepIndex="0"
        ...
        <FinishNavigationTemplate>
            <div class="sfButtonwrapper">
                <label class="icon-finish smlbtn-succ sfBtn">
                    Finish
        ...
        <StartNavigationTemplate>
            <div class="sfButtonwrapper">
                <label class="sfBtn smlbtn-succ icon-next">
                    Next 
                ...
                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:FileUpload ID="fileModule" ClientIDMode="static" runat="server" meta:resourcekey="fileModuleResource1" />
                            <label for="fileModule">Choose file</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
        ...
        <StepNavigationTemplate>
            <div class="sfButtonwrapper">
                <label class="sfBtn icon-next smlbtn-succ">
                    Next 
