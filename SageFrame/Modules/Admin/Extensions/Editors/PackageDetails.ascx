...
<div id="divPackageSettings" runat="server" class="clearfix">
    <div class="sfMarginTopPri  sfPadding">
        ...
        <div class="sfFormwrapper twoColForm keyAlign">
            <div class="sfFieldset">
                ...
                <div class="formValue">
                    ...
                    <asp:RequiredFieldValidator Display="Dynamic" ID="rfvPackageName" runat="server" ControlToValidate="txtPackageName"
                        ...
                        CssClass="sfRequired sfError"></asp:RequiredFieldValidator></div>
            </div>
            <div class="sfFieldset">
                <div class="formKey">
