<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NotInstallModule.ascx.cs"
    Inherits="Modules_Admin_Extensions_Editors_NotInstallModule" %>
                    ...
                    <div>
                        <div class="sfModuleDetails">
                            <div>
                                ...
                                <asp:LinkButton CssClass="icon-download sfBtn smlbtn-def" runat="server" ID="LinkButton1" CommandName="DownLoad"
                                    CommandArgument='<%# Eval("DemoLink") %>'></asp:LinkButton>
                                <asp:LinkButton CssClass="icon-download sfBtn smlbtn-def" runat="server" ID="lnkDownLoad" CommandName="DownLoad"
