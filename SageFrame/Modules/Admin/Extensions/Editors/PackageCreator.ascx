        ...
        FileUploader: function (element, divID, validExtension, hdnSQLScriptFileName) {
            ...
            upload = new AjaxUpload($('#' + element), {
                ...
                onComplete: function (file, response) {
                    ...
                    if (res && res.Status > 0) {
                        SageAlertDialog("Error while uploading file.");
                    }
                    else {
    ...
    <div class=" sfPadding">
        ...
        <div class="sfFormwrapper twoColForm">
            ...
            <div class="sfFieldset">
                ...
                <div class="formValue">
                    <div class="sfAvailableModules flexer">
...
<div id="div2" style="display: none">
    <div class="sfFormwrapper sfPadding">
        <div>
            ...
            <label for='<%=fuInstallScript.ClientID%>'>Choose File</label>
        ...
        <div>
            ...
            <asp:FileUpload ID="fuUnistallScript" runat="server" />
             <label for='<%=fuUnistallScript.ClientID%>'>Choose File</label>
...
<div id="div3" style="display: none">
    <div class="sfFormwrapper sfPadding">
        ...
        <asp:ListBox runat="server" ID="lstFolderFiles" SelectionMode="Multiple" CssClass="sfListmenu multipleselect" />
        <br />
        <br />
        <div class="sfCheckbox">
...
<div id="div4" style="display: none">
    <div class=" sfPadding">
        ...
        <div class="sfFormwrapper">
            <div class="sfFieldset" id="rowSource" runat="server">
                <div class="formKey" id="Td5" runat="server">
                    <asp:Label ID="lblSource" runat="server" Text="Source" CssClass="sfFormlabel"></asp:Label>
                </div>
                <div class="formValue" id="Td6" runat="server">
            ...
            <div class="sfFieldset" visible="false" runat="server">
                <div class="formKey">
        ...
        <div class="sfFormwrapper">
            <div class="sfFieldset" id="Tr3" runat="server">
                <div class="formKey" id="Td13" runat="server">
                    <asp:Label ID="Label6" runat="server" Text="Source" CssClass="sfFormlabel"></asp:Label>
                </div>

                <div class="formValue" id="Td14" runat="server">
            ...
            <div class="sfFieldset">
                ...
                <div class="sfFieldset" id="Tr4" runat="server" visible="False">
                    <div class="formKey" id="Td15" runat="server">
                        <asp:Label ID="Label11" runat="server" Text="Display Order" CssClass="sfFormlabel"></asp:Label>
                    </div>

                    <div class="formValue" id="Td16" runat="server">
        ...
        <div class="sfFormwrapper ">
            <div class="sfFieldset" id="Tr7" runat="server">
                <div class="formKey" id="Td21" runat="server">
                    <asp:Label ID="lblSettingControlSearc" runat="server" Text="Source" CssClass="sfFormlabel"></asp:Label>
                </div>

                <div class="formValue" id="Td22" runat="server">
            ...
            <div class="sfFieldset" id="Tr8" runat="server" visible="False">
                <div class="formKey" id="Td23" runat="server">
                    <asp:Label ID="Label24" runat="server" Text="Display Order" CssClass="sfFormlabel"></asp:Label>
                </div>

                <div class="formKey" id="Td24" runat="server">
...
<div id="div5" style="display: none">
    <div class="sfFormwrapper sfPadding">
        ...
        <asp:ListBox runat="server" ID="lstAssembly" SelectionMode="Multiple" CssClass="sfListmenubig sfListmenu multipleselect CheckDLL"
...
<div class="sfButtonwrapper">
    ...
    <label class="icon-next smlbtn-succ sfBtn">
        Next
    <asp:Button ID="btnNext" runat="server" AlternateText="Next" CausesValidation="False"
        CommandName="Next" CssClass="" Text="Next" meta:resourcekey="btnNextResource1"
        OnClick="btnSubmit_Click" />
    </label>
    <label class="icon-close smlbtn-danger sfBtn">
        Cancel
    <asp:Button ID="btnCancelled" runat="server" AlternateText="Cancel" CssClass=""
        Text="" meta:resourcekey="btnCancelResource2" UseSubmitBehavior="false"
