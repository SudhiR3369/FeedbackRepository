...
<div class="sfButtonwrapper">
    <asp:LinkButton ID="imbUninstall" runat="server" CausesValidation="False" meta:resourcekey="imbUninstallResource1"
        CssClass="icon-uninstall smlbtn-def sfBtn" Text="Uninstall Extension" OnClick="imbUninstall_Click" />
    <asp:LinkButton ID="imbCancel" runat="server" CausesValidation="False" CssClass="icon-close smlbtn-danger sfBtn"
...
<ajax:TabContainer ID="TabContainerManageModules" runat="server" ActiveTabIndex="3"
    ...
    <ajax:TabPanel ID="TabPanelModuleEditor" runat="server" meta:resourcekey="TabPanelModuleEditorResource1">
        ...
        <ContentTemplate>
                    ...
                    <div class=" sfMargintop">
                        ...
                        <div class="sfFormwrapper twoColForm">
                            ...
                            <div class="sfFieldset">
                                ...
                                <div class="formValue emptyKey">
                                    <asp:Label ID="lblIsPortable" runat="server" CssClass="sfFormlabel" Text="Is Portable?"></asp:Label>
                                    <asp:CheckBox ID="chkIsPortable" runat="server" CssClass="sfCheckbox inline" Enabled="False"
                            ...
                            <div class="sfFieldset">
                                <div class="formValue emptyKey">
                                    ...
                                    <asp:CheckBox ID="chkIsSearchable" runat="server" Checked="True" CssClass="sfCheckbox inline"
                            ...
                            <div class="sfFieldset">
                                ...
                                <div class="formValue emptyKey">
                                    ...
                                    <asp:CheckBox ID="chkIsUpgradable" runat="server" Checked="True" CssClass="sfCheckbox inline"
                            ...
                            <div class="sfFieldset">
                                ...
                                <div class="formValue emptyKey">
                                    ...
                                    <asp:CheckBox ID="chkIsPremium" runat="server" CssClass="sfCheckbox inline" meta:resourceKey="chkIsPremiumResource1"></asp:CheckBox>
            ...
            <div class="sfButtonwrapper">
                <asp:LinkButton ID="imbUpdate" runat="server" CssClass="icon-update smlbtn-succ sfBtn" Text="Update Module"
        ...
        <ContentTemplate>
            <asp:UpdatePanel ID="udpDefinitions" runat="server" Visible="False">
                <ContentTemplate>
                    ...
                    <div class="sfButtonwrapper button-paddleft">
                        <asp:LinkButton class="CommandButton" Text="Update Definition" ID="imbUpdateDefinition"
                            runat="server" ValidationGroup="ModuleDef" CssClass="icon-update smlbtn-succ sfBtn" CausesValidation="True"
        ...
        <ContentTemplate>
            <div class="sfCollapsewrapper">
                <div id="divModuleControls" runat="server" class="sfCollapsecontent">
                    ...
                    <div class="sfButtonwrapper">
                        <asp:LinkButton class="icon-addnew smlbtn-primary sfBtn" ID="imbAddControl" Text="Add Module Control"
