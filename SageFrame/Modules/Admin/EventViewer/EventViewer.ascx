...
<div class="sfButtonwrapper">
    <label class="sfLocale icon-clear smlbtn-def sfBtn">
        Clear Log
    ...
    <label class="sfLocale icon-page-preview smlbtn-secondary icon-user-export sfBtn">
...
<div class="sfGridwrapper sfEventview">
    <asp:GridView Width="100%" runat="server" ID="gdvLog" OnSelectedIndexChanged="gdvLog_SelectedIndexChanged"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderStyle-CssClass="sfDelete" HeaderText="Delete">
                <ItemTemplate>
...
<div class="sfExceptions">
    ...
    <div id="tblSendException" runat="server">
        <div>
            <p class="sfNote">
                <i class="icon-info"></i>
        ...
        <div class="sfFormwrapper">
            <div id="tblSendExceptionsInfo" runat="server">
                ...
                <div class="sfFieldset">
                    <div class="sfButtonwrapper">
                        <label class="sfLocale icon-send smlbtn-succ sfBtn">
                            Send
