        ...
        var TaskToDo = {
            ...
            BindEvents: function () {
                ...
                $('#dvTask,#dvSearchTaskList').on('click', '.btnDelete', function () {
                    ...
                    var ID = Id.split('_');
                    var id = ID[1];
                    SageConfirmDialog('Are you sure you want to delete task?').done(function () {
                    ...
                    success: function (data) {
                        if (data.d.length > 0) {
                            $.each(data.d, function (index, value) {
                                Data += '<div class="EditTaskWrapper sfFormwrapper" >';
                                Data += '<div class="sfFieldset" >';
                                Data += '<div class="formKey" >';
                                Data += '<span class="sfFormlabel">Task</span>';
                                Data += '</div>';
                                Data += '<div class="formValue" >';
                                ...
                                Data += '<div class="sfFieldset" >';
                                Data += '<div class="formKey" >';
                                Data += '<span class="sfFormlabel" >Date</span>';
                                Data += '</div>';
                                Data += '<div class="formValue" >';
                                ...
                                Data += '</div>';
                                Data += '</div>';
                                Data += '<div class="sfButtonwrapper">';
                                Data += ' <i  class="sfLocale icon-update sfBtn smlbtn-succ" id="btnTaskListEdit">Update</i>';
                                Data += ' <i  class="sfLocale icon-close sfBtn smlbtn-danger " id="btnTaskListCancel" >Cancel</i>';
                                Data += '</div>';
                                $('#' + id).append(Data);
                                $('#' + id).find('.note').hide();
                                $('#EditDate').datepicker({
