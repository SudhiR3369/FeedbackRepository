    ...
    $.createPageRoleSettings = function (p) {
        ...
        var PageRoleSettings = {
            ...
            BindPageWithRoles: function (data) {
                ...
                $.each(data.d, function (index, item) {
                    ...
                    if (item.RoleName.toLowerCase() === "superuser" || item.RoleName.toLowerCase() === "super user") {
                        ...
                        var updatebutton = '<button type="button" class="btnPermissionSave icon-update smlbtn-succ sfBtn sfSingleSaveBtn" id=PageBtn_' + item.PageID + '>Update</button>'
                        //html1 += '<td width="20%"><input type="button" class="btnPermissionSave smlbtn-succ sfBtn sfSingleSaveBtn" id=PageBtn_' + item.PageID + ' class="icon-save" value="save" /></td>';
                        html1 += '<td width="20%">' + updatebutton + '</td>';
                        html1 += '</tr>';
                    }
            ...
            BindRolesList: function (data) {
                var html = "";
                html += '<h3 class="icon-users">Roles</h3>';
