<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ArticleEditorManage.ascx.cs" Inherits="Modules_ArticleAdmin_EditorAdmin_ArticleEditorManage" %>

<h2 id="editorHeading" class="box-title">News Editor</h2>
