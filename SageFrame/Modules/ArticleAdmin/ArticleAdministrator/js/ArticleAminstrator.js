...
(function ($) {
    ...
    $.ArticleAdmin = function (p) {
        ...
        var EditorMgr = {
            ...
            UIEvents: function () {
                ...
                $('#btnSaveArticle').off().on('click', function () {
                    if (validator.form()) {
                        ...
                        if (editHtml == '' || viewHtml == '') {
                            ...
                            if ($('#slcNewsState').attr('data-ismessage') == "false")
            ...
            MakeAdminStateOnly: function () {
                var lst = $('#slcNewsState').find('option').not('option[value="1"],option[value="none"],option[value="9"]').remove();
            },
            ...
            ClearEditor: function () {
                ...
                $('#btnSaveArticle').addClass('icon-save').removeClass('icon-update').text('Save');
                //manage category
                ...
                $('#slcNewsState').html($('#slcfltrStates').html());
                $('#slcNewsState').find('option').eq(0).text('select State').val('none');

                $('#slcfltrStates').val('none');
                $('#txtCategoryValidate').val('');
            ...
            BindArticleList: function (data) {
                ...
                if (data.length > 0) {
                    ...
                    $.each(data, function (index, item) {
                        ...
                        html += '</div></div>';
                        html += '<div class="actionclass actionLinkClass" >';
            ...
            BindArticleToForm: function (data) {
                ...
                if (data != null) {
                    ...
                    EditorMgr.ClearEditor();
                    $('#btnSaveArticle').removeClass('icon-save').addClass('icon-update').text('Update');
                    ...
                    $('#slcNewsState').val(article.StateID);
                    var articleAssets = '';
                    var assetsItem = '';
                    var count = 0;
    ...
    $.fn.ArticleAdminstrator = function (p) {
        $.ArticleAdmin(p);
    };
})(jQuery);
