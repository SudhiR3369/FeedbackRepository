(function ($) {
        ...
        var FileManager = {
            ...
            BindEvents: function () {
                ...
                $('#divFileList').off().on('click', 'tr td a.download_link span#spnEditImage', function () {
                    ...
                    var fileAbsolutePath = RealFilePath + "\\" + imageName;
                    var AbsPath = RealFilePath.split('\\' + FileManager.config.hostdirName + '\\');
                    var RealAbsPath = "";
                    if (AbsPath.length > 1) {
                        RealAbsPath = AbsPath[1] + "/" + imageName;
                    ...
                    var ShareLink = SageFrameHostURL + "\\" + AbsPath[AbsPath.length - 1].replace(rootPath, "") + "\\" + imageName;
                    ...
                    if (imageName.match(imageRegex)) {
                        ...
                        FileManager.ReadFiles(fileAbsolutePath, Mode);
                        FileManager.ShowPopUp("divEditMode");
                        $('#divImages').hide();
                        $('#divEditFile').show();
    ...
    //Create functon whisch is called in .aspx file
    $.fn.FManager = function (p) {
        $.FM(p);
    };
