...
public partial class Modules_DigitalMarketing_SocialMediaManagement_SocialMediaManagement : BaseAdministrationUserControl
{

    string twitterCallBackContent = string.Empty, facebookCallBackContent = string.Empty;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        IncludeCss("SocialMediaManagement", "/Modules/DigitalMarketing/SocialMediaManagement/css/SocialMediaManagement.css");
        IncludeJs("SocialFeedShare", "/Modules/DigitalMarketing/SocialMediaManagement/js/SocialMediaManagement.js");
    ...
    {
        if (Session[SuccessMessageKey] != null) Session.Remove(SuccessMessageKey);
        ...
        if (content != string.Empty)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        if (facebookCallBackContent != string.Empty)
                            fullMessage += facebookCallBackContent;
                        else
                    ...
                    if (fullMessage.Trim() == string.Empty)
                    {
                        fullMessage = "Unable to share your post at the moment.";
                    }

                    ShowMessage(SageMessageTitle.Exception.ToString(), fullMessage, "", SageMessageType.Error);
            ...
            catch (Exception ex)
            {
                ...
                SageMessage.GetSageModuleLocalMessageByVertualPath("Modules/DigitalMarketing/SocialMediaManagement/ModuleLocalText",
    ...
    public bool PostFacebook()
    {
        ...
        else
        {
            ...
            try
            {
                ...
                else { facebookCallBackContent = "Unable to obtain an access token for facebook"; }
    ...
    public void ClearSessionKeys()
    {
        ...
        facebookCallBackContent = string.Empty;
