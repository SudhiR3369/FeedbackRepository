    ...
    <div class="sfUserRegistration">
        ...
        <div class="sfFormwrapper twoColForm">
            <div class="sfUserRegistrationInfoLeft" id="divRegister" runat="server">
                 <div class="sfFormKey"><h2>Registration</h2>
                    ...
                    <div class="sfFieldset " runat="server" id="captchaTR" style="clear:both">
                        <div class="formKey">
                            <asp:Label ID="CaptchaLabel" runat="server" Text="" AssociatedControlID="CaptchaImage"
                                CssClass="sfFormlabel" meta:resourcekey="CaptchaLabelResource1"></asp:Label>
                        </div>
                        <div class="formValue sfCatpchatd" >
                    ...
                    <div class="sfFieldset blockLevel">
                        <div class="formKey">
			 ...
			 <div class="sfButtonwrapper">
                                <label for='<%=FinishButton.ClientID%>' class="login-btn sfBtn smlbtn-primary">
                                <span class="icon-register"></span>
                                <asp:Button ID="FinishButton" runat="server" AlternateText="Finish" ValidationGroup="CreateUserWizard1"
                                    CommandName="MoveComplete" Text="Register" OnClick="FinishButton_Click"
