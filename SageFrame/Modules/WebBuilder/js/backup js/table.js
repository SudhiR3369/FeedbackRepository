            ...
            "tabs": {
                "Basic":
                {
                    ...
                    "onload": function ($item) {
                        ...
                        $('#tblGraph').on('click', function () {
                            ...
                            SageConfirmDialog('Do you want to continue with selected table?').done(function () {
                ...
                "Row-Col": {
                    ...
                    "onload": function ($item) {
                        ...
                        initEvent();
                        function initEvent() {
                            $('.ResposiveTableColorPicker.resTblLineColor').css('background-color', $parent.find('.responsivetablewrap').attr('data-linecolor'));
                            UIEvents();
