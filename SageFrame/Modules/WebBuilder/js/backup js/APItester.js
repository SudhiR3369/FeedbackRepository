var text = {
    "apitester": {
        ...
        "remove": function ($cloneDOM) {
            ...
            APICntrl.MethodNames = "GetPageLists";
            //you need to set params here according to the logic;
            APICntrl.Parameters = "0,1,2";
            //your componentID here
            APICntrl.ComponentID = 5;
            APICntrl.Type = "URL";
            EasyLibrary.SetAPI(APICntrl);
            ...
            APISettingCntrl.NameSpace = "SageFrame.WebBuilder";
            APISettingCntrl.ClassNames = "WebBuilderController";
            APISettingCntrl.MethodNames = "GetPageLists";
            //you need to set params here according to the logic;
            APISettingCntrl.Parameters = 1;
            //your componentID here
            APISettingCntrl.ComponentID = "News";
            APISettingCntrl.Type = "method";
