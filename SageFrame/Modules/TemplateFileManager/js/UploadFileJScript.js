...
(function ($) {
    ...
    $.fn.UploadFile = function (opt) {
        ...
        function LoadDocument() {
            var httpurl = WorkLogPath + 'UploadHandler.ashx?mode=0' + '&fn=' + fileName + '&userModuleId=' + templateFileManagerUserModuleID + '&portalID=' + SageFramePortalID + '&userName=' + SageFrameUserName + '&secureToken=' + SageFrameSecureToken;
            Upload(httpurl)
        }
        // ----End----
        function checkStatus() {
            width = "";
            height = "";
            var httpurl = WorkLogPath + "UploadHandler.ashx?wid=" + width + "&he=" + height + "&mode=1" + "&fn=" + fileName + "&gID=0" + "&userModuleId=" + templateFileManagerUserModuleID + "&portalID=" + SageFramePortalID + "&userName=" + SageFrameUserName + "&secureToken=" + SageFrameSecureToken;
            Upload(httpurl);
        }
        ...
        function loadThumb() {
            ...
            if (bool == 0) {
                ...
                if (thumb == false) {
                    //SageAlertDialog('Your Image has been Updated Sucesfully', 'Image Update Success');
                }
                else {
                    //SageAlertDialog('Thumb Created Sucesfully', 'Created Success');
                }
            }
            else {
                //SageAlertDialog('Your Image is not Updated ', 'Update Failure');
            }
        }
        //preview image
        ...
        function createThumbnail(oWid, oHei) {
            ...
            httpurl = WorkLogPath + "UploadHandler.ashx?twid=" + tWidth + "&the=" + tHeight + "&x1=" + x1 + "&y1=" + y1 + "&wid=" + oWid + "&he=" + oHei + "&mode=2&edt=yes&fn=" + filename + "&userModuleId=" + templateFileManagerUserModuleID + "&portalID=" + SageFramePortalID + "&userName=" + SageFrameUserName + "&secureToken=" + SageFrameSecureToken;
            Upload(httpurl);
        }
    }
})(jQuery);
