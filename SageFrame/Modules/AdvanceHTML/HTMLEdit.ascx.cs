    ...
    public partial class HTMLEdit : BaseAdministrationUserControl
    {
        ...
        protected void imbSave_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                {
                    objHtml.HtmlTextUpdate(hdnUserModuleID.Value, HTMLBodyText, GetCurrentCultureName, chkAllowComment.Checked, chkPublish.Checked, true, DateTimeHelper.GetUtcTime(DateTime.Now), GetPortalID, GetUsername);
                ...
                {
                    objHtml.HtmlTextAdd(hdnUserModuleID.Value, HTMLBodyText, GetCurrentCultureName, chkAllowComment.Checked, true, chkPublish.Checked, DateTimeHelper.GetUtcTime(DateTime.Now), GetPortalID, GetUsername);
        ...
        protected void imbAdd_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    objHtml.HtmlCommentUpdate(Session["EditCommentID"], txtComment.Text, chkApprove.Checked, chkApprove.Checked, true, DateTimeHelper.GetUtcTime(DateTime.Now), GetPortalID, GetUsername);
                ...
                {
                    objHtml.HtmlCommentAdd(hdfHTMLTextID.Value, txtComment.Text, chkApprove.Checked, chkIsActive.Checked, DateTimeHelper.GetUtcTime(DateTime.Now), GetPortalID, GetUsername);
