        ...
        var MenuMgr = {
            ...
            BindMenuEvents: function () {
                ...
                if (activeMenuID == 0) {
                    ...
                    $('#menuList').find('ul li[id="' + activeMenuID + '"] span.sfMenuname').trigger('click');
                }
            },
            ...
            UpdatePageItem: function (parentID, parentID) {
            ...
            LoadDefaultMenuFromSetting: function () {
                $.ajax({
                    ...
                    contentType: MenuMgr.config.contentType,
                    cache: MenuMgr.config.cache,
                    url: MenuMgr.config.baseURL + "GetSageMenu",
                    data: JSON2.stringify({
                        PortalID: SageFramePortalID,
                        UserModuleID: MenuMgr.config.UserModuleID,
                        UserName: SageFrameUserName,
            ...
            UpdateSelectedMenu: function (menuID) {
                $.ajax({
                    ...
                    contentType: MenuMgr.config.contentType,
                    cache: MenuMgr.config.cache,
                    url: MenuMgr.config.baseURL + "SaveSageMenu",
                    data: JSON2.stringify({
                        UserModuleID: MenuMgr.config.UserModuleID,
                        PortalID: MenuMgr.config.PortalID,
                        SettingKey: 'MenuID',
