                    ...
                    <div class="messegeArea">
                        <div class="requiredField">
                            <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="UserName"
                                ...
                                Text="UserName is required" Display="Dynamic"></asp:RequiredFieldValidator>
                            <div class="separator"></div>
                            <asp:RequiredFieldValidator ID="PasswordRequired" runat="server" ControlToValidate="Password"
                                ErrorMessage="Password is required." ToolTip="Password is required." ValidationGroup="Login1"
                                CssClass="sfErrorA" Text="Password is required" Display="Dynamic"></asp:RequiredFieldValidator>
                            <div class="separator"></div>
                        ...
                        <div class="sfFormwrapper">
                            <div class="sfFieldset">
                                <span class="formValue">
                                    <asp:TextBox ID="UserName" runat="server" placeholder="Username" meta:resourcekey="UserNameResource1" autofocus="autofocus"
                            ...
                            <div class="sfFieldset">
                                <span class="formValue">
                                    <asp:TextBox ID="Password" runat="server" TextMode="Password" placeholder="Password"
                                        meta:resourcekey="PasswordResource1" CssClass="sfInputbox passWord"></asp:TextBox>
        ...
        <div class="flexible-box">
            <div class="main-login-area">
                <div class="sfLogin">
                    ...
                    <p>
                        Do you want to 
            <uc1:LoginStatus ID="LoginStatus1" runat="server" /> ? or
                    </p>
                    <p>
                        <asp:LinkButton ID="lnkBacktoEditor" runat="server" Text="Play around with  webbuilder" OnClick="lnkBacktoEditor_Click"
                            EnableViewState="false" CssClass="sfBtnlogin "></asp:LinkButton>
                    </p>
                </div>
            </div>
        </div>
