        ...
        var SiteAnalyticControl = {
                ...
                $('#tblVisitedPageList').PagingVisited({
                    ...
                    OnComplete3: function (msg) {
                        ...
                        if (msg.d.length > 0) {
                            ...
                            var PageList = msg.d;
                            html += '<tr><th>Page</th><th>Visit Time</th></tr>';
                            $.each(PageList, function (index, item) {
                                var styleClass = index % 2 == 0 ? 'class="sfOdd"' : "sfEven";
                                if (item.VistPageWithoutExtension == '')
                                    item.VistPageWithoutExtension = p.DefaultPage;
                ...
                $("#tblVisitedCountryList").PagingCountry({
                    ...
                    OnComplete2: function (data) {
                        ...
                        if (data.d.length > 0) {
                            ...
                            html += '<tr><th>Country</th><th>Visit Time</th></tr>';
            ...
            GetRefSite: function () {
                $('#tblRefSite').PagingRef({
                    ...
                    OnComplete3: function (msg) {
                        ...
                        if (msg.d.length > 0) {
                            var RefList = msg.d;
                            html += '<tr><th>Reference Site</th><th>Visit Time</th></tr>';
                ...
                $('#tblBrowserList').PagingBrowsed({
                    ...
                    OnComplete1: function (msg) {
                        ...
                        if (msg.d.length > 0) {
                            ...
                            var PageList = msg.d;
                            html += '<tr><th>Browser</th><th>Visit Time</th></tr>';
                            $.each(PageList, function (index, item) {
                                var styleClass = index % 2 == 0 ? 'class="sfOdd"' : "sfEven";
            ...
            MonthlyVisitMeterGaugeChart: function (Count) {
                ...
                if (Count != 0) {
                    ...
                    $('#MonthlyVisitMeterGaugeChart').html('Data not found.');
                }
            },
            ...
            BrowserWiseVisit: function (data) {
                if (data != 0) {
                    ...
                    $('#BrowserWiseVisit').html('Data Not Found.');
                }
            },
            DateWiseVisit: function (DailyVisit) {
                ...
                if (DailyVisit != 0) {
                    ...
                    $('#DailyVisit').html('Data not found');
                }
            },
            ...
            ajaxSuccess: function (msg) {
                switch (SiteAnalyticControl.config.ajaxCallMode) {
                    ...
                    case 5:
                        ...
                        if (msg.d.length > 0) {
                            $.each(msg.d, function (index, item) {
                                if (item.VistPageWithoutExtension == null || item.VistPageWithoutExtension.length < 1) {
