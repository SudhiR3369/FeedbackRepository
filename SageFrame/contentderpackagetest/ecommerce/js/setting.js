...
$(function () {
    ...
    $('#fluLogo').off().on('change', function () {
        LogoUploader();
    });
});
function LogoUploader() {
    var formData = new FormData();
    formData.append('LogoImage', $('#fluLogo')[0].files[0]);
    $.ajax({
        type: 'post',
        url: LogoSetting.config.handlerUrl + '?userModuleId=' + LogoSetting.config.moduleId + '&portalID=' + SageFramePortalID + '&userName=' + SageFrameUserName + '&secureToken=' + SageFrameSecureToken,
        data: formData,
