...
namespace SageFrame
{
    public partial class Sagin_Admin : PageBase, SageFrameRoute
    {
        ...
        private void SetGlobalVariable()
        {
            ...
            fontAwesome.Href = ResolveUrl("~/") + "Administrator/Templates/Default/css/font-awesome.min.css";
        ...
        protected void fileUpload_Click(object sender, EventArgs e)
        {
            ...
            {
                string tempFilePath = Server.MapPath("~/Temp/sageframe.png");
                string saveFinalPath = Server.MapPath("~/images/sageframe.png");
                this.fileUpload.SaveAs(tempFilePath);
                PictureManager.CreateThmnail(tempFilePath, 332, 66, saveFinalPath);
            }
