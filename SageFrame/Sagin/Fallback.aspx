        ...
        $(function () {
            ...
            $('#btnActivate').bind("click", function () {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    url: "<%=appPath%>" + "/Sage_Services/SageFrameGlobalWebService.asmx/" + "ActivateDefaultTemplate",
                    data: param,
...
<body>
    ...
    <div class="sfFallback">
        <div class="sfLogoholder">
            <a class="sflogo" target="_blank" href="http://www.contentder.com/"> 
                <asp:Image ID="imgLogo" runat="server" alt="Contentder" />
            </a>
        </div>
