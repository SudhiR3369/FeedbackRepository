...
namespace SageFrame.Modules
{
    ...
    public class ModuleController
    {
        ...
        /// <summary>
        /// Connect to database and asign module to admin page right panel
        /// </summary>
        /// <param name="ModuleDefID"></param>
        /// <param name="UserName"></param>
        public void AssignModuleToAdminPanel(int? ModuleDefID, string UserName)
        {
            ModuleProvider objProvider = new ModuleProvider();
            objProvider.AssignModuleToAdminPanel(ModuleDefID, UserName);
        }
