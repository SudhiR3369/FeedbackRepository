...
namespace RegisterModule
{
    ...
    public static class ZipUtil
    {
        ...
        public static bool UnZipFiles1(string zipPathAndFile, string outputFolder, ref string ExtractedPath, string password, bool deleteZipFile, string deletePath)
        {
            bool msg = true;
            try
            {
