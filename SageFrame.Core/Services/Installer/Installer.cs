...
namespace SageFrame.SageFrameClass.Services
{
    ...
    public class Installers : BaseAdministrationUserControl
    {
        ...
        public void InstallPackageCore(ModuleInfo module, XmlDocument doc, ref  ArrayList dllFiles, ref  string _unistallScriptFile)
        {
            ...
            int[] outputValue;
            ModuleController objProvider = new ModuleController();
            outputValue = objProvider.AddModules(module, false, 0, true, DateTimeHelper.GetUtcTime(DateTime.Now), GetPortalID, GetUsername);
            ...
            _newPortalmoduleID = objProvider.AddPortalModules(GetPortalID, _newModuleID, true, DateTimeHelper.GetUtcTime(DateTime.Now), GetUsername);
            ...
            try
            {
                ...
                objProvider.AddModulePermission(_newModuleDefID, _permissionIDView, GetPortalID, _newPortalmoduleID, true, GetUsername, true, DateTimeHelper.GetUtcTime(DateTime.Now), GetUsername);

                // get the default module EDIT permissions
                int _permissionIDEdit = objProvider.GetPermissionByCodeAndKey("SYSTEM_EDIT", "EDIT");

                //insert into module permissions i.e., ModuleDefPermission and PortalModulePermission
                objProvider.AddModulePermission(_newModuleDefID, _permissionIDEdit, GetPortalID, _newPortalmoduleID, true, GetUsername, true, DateTimeHelper.GetUtcTime(DateTime.Now), GetUsername);
            }
            catch (Exception ex)
            {
            ...
            foreach (XmlNode xn2 in xnList2)
            {
                ...
                objProvider.AddModuleCoontrols(_newModuleDefID, _moduleControlKey, _moduleControlTitle, _moduleControlSrc,
                                           IconFile, controlType, 0, _moduleControlHelpUrl, _moduleSupportsPartialRendering, true, DateTimeHelper.GetUtcTime(DateTime.Now),
        ...
        public ModuleInfo InstallPackage(ModuleInfo module)
        {
            XmlDocument doc = new XmlDocument();
