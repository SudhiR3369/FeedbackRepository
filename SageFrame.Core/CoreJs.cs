                ...
                foreach (CDNInfo objInfo in obj)
                {
                    ...
                    if (GetCDNPosition == 2)
                    {
                        ...
                        if (IsAdmin && IsUserLoggedIn)//Mode=1
                        {
                            ...
                            lstJS.Add(new CssScriptInfo("Core", "~/Administrator/Templates/Default/js/colorpicker.js", 0, true, true));
                ...
                if (!IsHandheld)
                {
                    ...
                    List<CssScriptInfo> lstJS = new List<CssScriptInfo>{
                                                   ...
                                                   // new CssScriptInfo("Core", "dashboardjs.js", "/Administrator/Templates/Default/js/", 0, false),
                                                    ...
                                                    new CssScriptInfo("Core", "colorpicker.js", "/Administrator/Templates/Default/js/", 0, false),
                    ...
                    if (IsAdmin && IsUserLoggedIn)//Mode=1
                    {
                        ...
                        lstJS.Add(new CssScriptInfo("Core", "colorpicker.js", "/Administrator/Templates/Default/js/", 0, false));
