...
namespace SageFrame.Services
{
    ...
    public class AuthenticateService : System.Web.Services.WebService
    {
        ...
        /// </summary>
        /// <returns>bool </returns>
        public bool IsPostAuthenticated(CommonAuthParam auth)
        {
        ...
        /// authenticates method for view controls.
        /// </summary>
        /// <param name="CommonAuthParam">CommonAuthParam</param>

        /// <returns>bool </returns>
        public bool IsPostAuthenticatedView(CommonAuthParam auth)
        {
