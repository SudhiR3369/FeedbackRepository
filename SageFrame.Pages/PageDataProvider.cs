...
namespace SageFrame.Pages
{
    ...
    public class PageDataProvider
    {
        ...
        public List<PageEntity> GetMenuFront(int PortalID, bool IsAdmin, int SiteID)
        {
            try
            {
                List<PageEntity> lstPages = new List<PageEntity>();
                ...
                ParaMeterCollection.Add(new KeyValuePair<string, object>("@PortalID", PortalID));
                ParaMeterCollection.Add(new KeyValuePair<string, object>("@IsAdmin", IsAdmin));
                ParaMeterCollection.Add(new KeyValuePair<string, object>("@SiteID", SiteID));
                SQLHandler sagesql = new SQLHandler();
                lstPages = sagesql.ExecuteAsList<PageEntity>("[dbo].[usp_GetPagesBySiteID]", ParaMeterCollection);
                return lstPages;
            }
            catch (Exception e)
            {
                ...
                List<KeyValuePair<string, object>> ParaMeterCollection = new List<KeyValuePair<string, object>>
                                                                            {
                                                                                ...
                                                                                new KeyValuePair<string, object>(
                                                                                    "@StartDate", DateTimeHelper.GetUtcTime(DateTime.Now)),
                                                                                new KeyValuePair<string, object>(
                                                                                    "@EndDate", DateTimeHelper.GetUtcTime(DateTime.Now)),
                                                                                new KeyValuePair<string, object>(
                                                                                    "@RefreshInterval",
