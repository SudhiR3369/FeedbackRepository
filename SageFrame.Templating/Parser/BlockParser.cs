    ...
    public class BlockParser
    {
        ...
        public static string ParseFixedBlocks(XmlTag placeholder, List<CustomWrapper> lstWrapper)
        {
            ...
            for (int i = 0; i < positionsAr.Length; i++)
            {
                ...
                sb.Append(Mode == 2 ? "<div class='sfWrapper pane_" + positionsAr[i] + "'>" : "<div class='sfWrapper sfCurve'>");
        ...
        public static string ProcessMiddlePlaceholders(Placeholders placeholder, XmlTag middleblock, List<CustomWrapper> lstWrapper, int _Mode)
        {
            ...
            if (!isAvailable)
            {
                sb.Append(Mode == 2 ? "<div class='" + placeholder.ToString().ToLower() + "'><div class='sfWrapper  pane_" + placeholder.ToString().ToLower() + "'>" : "<div class='" + placeholder.ToString().ToLower() + "'><div class='sfWrapper sfCurve'>");
