...
namespace SageFrame.Security
{
    ...
    public class MembershipController : SageFrameMembershipProvider
    {
        ...
        public void UpdateUserStatus(UserInfo user)
        {
            try
            {
                MembershipDataProvider memData = new MembershipDataProvider();
                memData.UpdateUserStatus(user);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        {      
            ...
            {
                MembershipDataProvider memData = new MembershipDataProvider();
                return memData.GetDataByUserId(userID);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public List<UserInfo> GetDataByDateRange(int PageNumber, int PageSize, FilterUserInfo userObj)
        {
            ...
            {
                MembershipDataProvider memData = new MembershipDataProvider();
                return memData.GetDataByDateRange(PageNumber, PageSize, userObj);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public List<RoleInfo> LoadAllRolesForUser()
        {
            ...
            {
                MembershipDataProvider memData = new MembershipDataProvider();
                return memData.LoadAllRolesForUser();
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public override bool UpdateUser(UserInfo obj, out UserUpdateStatus status)
        {
            try
            {
                return (MembershipDataProvider.UpdateUser(obj, out status));
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public string UpdateUserLoginActivity(UserInfo objInfo)
        {
            MembershipDataProvider objProv = new MembershipDataProvider();
          return  objProv.UpdateUserLoginActivity(objInfo);
        }

        public string GetRedirectUrlByRoleID(string roleName)
        {
            MembershipDataProvider objProv = new MembershipDataProvider();
            return objProv.GetRedirectUrlByRoleID(roleName);
        }
    }
}
