...
namespace SageFrame.Security
{
    ...
    public class RoleController : SageFrameRoleProvider
    {
        ...
        public override void CreateRole(RoleInfo role, string roleID, out RoleCreationStatus status)
        {
            MembershipDataProvider.CreateRole(role, roleID, out status);
        }
        /// <summary>
        ...
        public override string GetRoleIDs(string UserName, int PortalID)
        {
            return (MembershipDataProvider.GetRoleIDs(UserName, PortalID));
        }
        /// <summary>
