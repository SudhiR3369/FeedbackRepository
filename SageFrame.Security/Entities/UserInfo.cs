...
namespace SageFrame.Security.Entities
{
    ...
    {  
        ...
        public DateTime LastActivityDate
        {
            get
            {
                return DateTimeHelper.GetLocalTime(_LastActivityDate);
            }
            set
            {
        ...
        public DateTime LastLoginDate
        {
            get
            {
                return DateTimeHelper.GetLocalTime(_LastLoginDate);
            }
            set
            {
        ...
        public DateTime LastPasswordChangeDate
        {
            get
            {
                return DateTimeHelper.GetLocalTime(_LastPasswordChangeDate);
            }
            set
            {
