...
namespace SageFrame.Security.Providers
{
    ...
    public class MembershipDataProvider
    {
        ...
        public static SageFrameUserCollection SearchUsers(string RoleID, string SearchText, int PortalID, string UserName)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    obj.AddedOn = DateTimeHelper.GetUtcTime(reader["AddedOn"].ToString());
                    lstUsers.Add(obj);
                }
                reader.Close();
                userColl.UserList = lstUsers;
        ...
        //New For News Reporter
        public List<UserInfo> GetDataByUserId(Guid userID)
        {       
            ...
            try
            {
                return sqLH.ExecuteAsList<UserInfo>("usp_Article_User_GetUserDetByUserID", Param);
            }
            catch (Exception ex)
            { 
                throw ex;
        ...
        public void UpdateUserStatus(UserInfo user)
        {
            SQLHandler sqLH = new SQLHandler();
            List<KeyValuePair<string, object>> Param = new List<KeyValuePair<string, object>>();
            Param.Add(new KeyValuePair<string, object>("@UserId", user.UserID));
            Param.Add(new KeyValuePair<string, object>("@UserName", user.UserName));
            Param.Add(new KeyValuePair<string, object>("@status", user.IsActive));
            try
            {
                sqLH.ExecuteNonQuery("[usp_Article_User_UpdateUserStatus]", Param);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        //New 
        public List<UserInfo> GetDataByDateRange(int PageNumber, int PageSize, FilterUserInfo userObj)
        {         
            SQLHandler sqLH = new SQLHandler();
            List<KeyValuePair<string, object>> Param = new List<KeyValuePair<string, object>>();
            Param.Add(new KeyValuePair<string, object>("@pageNumber", PageNumber));
            Param.Add(new KeyValuePair<string, object>("@pageSize", PageSize));
            Param.Add(new KeyValuePair<string, object>("@searchTerm", userObj.UserName));
            Param.Add(new KeyValuePair<string, object>("@role", userObj.RoleID));
            Param.Add(new KeyValuePair<string, object>("@fromDate", userObj.DateFrom));
            Param.Add(new KeyValuePair<string, object>("@toDate", userObj.DateTo));
            try
            {
                return sqLH.ExecuteAsList<UserInfo>("usp_Article_User_GetUserDetByDateRange", Param);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        //New
        public List<RoleInfo> LoadAllRolesForUser()
        {
            SQLHandler sqLH = new SQLHandler();
            List<KeyValuePair<string, object>> Param = new List<KeyValuePair<string, object>>();
            try
            {
                return sqLH.ExecuteAsList<RoleInfo>("usp_Article_User_GetRolesForUser", Param);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public static bool DeleteUser(UserInfo user)
        {
            ...
            try
            {
                ...
                ParamCollInput.Add(new KeyValuePair<string, object>("@UserID", user.UserID));
        ...
        public static UserInfo GetUserDetails(string UserName, int PortalID)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    obj.LastName = reader["LastName"].ToString();
                    obj.Email = reader["Email"].ToString();
                    obj.CreatedDate = DateTimeHelper.GetUtcTime(reader["CreateDate"].ToString());
                    obj.LastPasswordChangeDate = DateTimeHelper.GetUtcTime(reader["LastPasswordChangedDate"].ToString());
                    obj.LastActivityDate = DateTimeHelper.GetUtcTime(reader["LastActivityDate"].ToString());
                    obj.LastLoginDate = DateTimeHelper.GetUtcTime(reader["LastLoginDate"].ToString());
        ...
        public static void CreateRole(RoleInfo obj, string roleID, out RoleCreationStatus status)
        {
            List<KeyValuePair<string, object>> ParamCollInput = new List<KeyValuePair<string, object>>();
            ParamCollInput.Add(new KeyValuePair<string, object>("@ApplicationName", obj.ApplicationName));
        ...
        #endregion
        /// <summary>
        /// Connect to the database and obtain roles ids.
        /// </summary>
        /// <param name="UserName">User name.</param>
        /// <param name="PortalID">PortalID</param>
        /// <returns>Role IDs with comma separator.</returns>
        public static string GetRoleIDs(string UserName, int PortalID)
        {
            string sp = "[dbo].[usp_RoleIDsGetByUserName]";
            SQLHandler sagesql = new SQLHandler();
            List<KeyValuePair<string, object>> ParamCollInput = new List<KeyValuePair<string, object>>();
            ParamCollInput.Add(new KeyValuePair<string, object>("@UserName", UserName));
            ParamCollInput.Add(new KeyValuePair<string, object>("@PortalID", PortalID));
        ...
        internal string UpdateUserLoginActivity(UserInfo objInfo)
        {
            string sp = "[dbo].[usp_UpdateUserActivity]";
            SQLHandler sagesql = new SQLHandler();
            try
            {
                List<KeyValuePair<string, object>> ParamCollInput = new List<KeyValuePair<string, object>>();
                ParamCollInput.Add(new KeyValuePair<string, object>("@LastLoginDate", objInfo.LastLoginDate));
                ParamCollInput.Add(new KeyValuePair<string, object>("@UserID", objInfo.UserID));
                return   sagesql.ExecuteAsScalar<string>(sp, ParamCollInput);           
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        internal string GetRedirectUrlByRoleID(string roleName)
        {
            string sp = "[dbo].[usp_GetRedirectUrlByRoleID]";
            SQLHandler sagesql = new SQLHandler();
            try
            {
                List<KeyValuePair<string, object>> ParamCollInput = new List<KeyValuePair<string, object>>();
