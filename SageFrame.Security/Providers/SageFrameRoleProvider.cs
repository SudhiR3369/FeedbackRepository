...
namespace SageFrame.Security
{
    ...
    {
        public abstract void CreateRole(RoleInfo role,string roleID, out RoleCreationStatus status);
        ...
        public abstract string GetRoleIDs(string UserName, int PortalID);
